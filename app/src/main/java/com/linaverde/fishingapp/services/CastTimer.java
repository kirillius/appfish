...
public class CastTimer extends BroadcastReceiver {

    final public
    static String ONE_TIME = "onetime";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (extras != null &&
                extras.getBoolean(ONE_TIME, Boolean.FALSE)) {
    ...
    public void SetAlarm(Context context) {
        ...
        Intent intent = new Intent(context, CastTimer.class);
