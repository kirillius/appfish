...
public class SectorAdapter extends ArrayAdapter<TeamsQueue> {
    Context context;
    List<TeamsQueue> values;

    public SectorAdapter (Context context, TeamsQueue[] values) {
    ...
    public View getView(int pos, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.sector_list_item, parent, false);
        ...
        TextView sector = (TextView) rowView.findViewById(R.id.tv_sector);
        ...
        if (team.getSector() !=0)
            sector.setText(Integer.toString(team.getSector()));
